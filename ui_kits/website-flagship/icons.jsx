/* Laive AI flagship — self-contained inline-SVG icon set (lucide paths).
   Mirrors the DS Icon API (name, size, style) but renders real <svg> with
   currentColor stroke — no CDN, no CSS mask. Renders crisply everywhere,
   captures in screenshots, immune to CSP/network. */
...
const FS_ICON_PATHS = {
  ...
  'pen-tool': '<path d="M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.375 2.625a1 1 0 0 1 3 3l-9.013 9.014a2 2 0 0 1-.853.505l-2.873.84a.5.5 0 0 1-.62-.62l.84-2.873a2 2 0 0 1 .506-.852z"/>',
...
function FsIcon({ name = 'sparkles', size = 20, style = {}, strokeColor, strokeWidth = 2, ...rest }) {
  const inner = FS_ICON_PATHS[name] || FS_ICON_PATHS.sparkles;
  return (
    <svg
      role="img" aria-label={name}
      width={size} height={size} viewBox="0 0 24 24"
      fill="none" stroke={strokeColor || 'currentColor'} strokeWidth={strokeWidth}
...
Object.assign(window, { FsIcon, FS_ICON_PATHS });
